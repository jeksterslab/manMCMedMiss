...
#> cp        0.2335 0.0290 5000  0.1472  0.1606  0.1775 0.2915 0.3106 0.3326
#> b         0.5112 0.0296 5000  0.4173  0.4375  0.4532 0.5719 0.5906 0.6165
#> a         0.4809 0.0283 5000  0.3885  0.4085  0.4268 0.5365 0.5518 0.5729
#> Y~~Y      0.5542 0.0267 5000  0.4734  0.4865  0.5008 0.6066 0.6226 0.6439
#> M~~M      0.7564 0.0366 5000  0.6366  0.6623  0.6854 0.8310 0.8519 0.8685
#> X~~X      1.0591 0.0496 5000  0.8953  0.9385  0.9613 1.1573 1.1884 1.2271
#> Y~1      -0.0127 0.0256 5000 -0.0940 -0.0755 -0.0621 0.0370 0.0570 0.0751
#> M~1      -0.0223 0.0286 5000 -0.1085 -0.0946 -0.0785 0.0341 0.0536 0.0651
#> X~1       0.0025 0.0340 5000 -0.1102 -0.0867 -0.0651 0.0684 0.0911 0.1143
#> indirect  0.2458 0.0201 5000  0.1807  0.1961  0.2069 0.2863 0.3028 0.3190
#> direct    0.2335 0.0290 5000  0.1472  0.1606  0.1775 0.2915 0.3106 0.3326
#> total     0.4794 0.0282 5000  0.3951  0.4084  0.4251 0.5347 0.5568 0.5738
```
...
#> 1         Y  ~        X       cp  0.234 0.030  7.881  0.000    0.177    0.292
#> 2         Y  ~        M        b  0.511 0.030 16.809  0.000    0.452    0.570
#> 3         M  ~        X        a  0.481 0.029 16.865  0.000    0.424    0.537
#> 4         Y ~~        Y           0.554 0.027 20.230  0.000    0.500    0.608
#> 5         M ~~        M           0.756 0.037 20.637  0.000    0.684    0.825
#> 6         X ~~        X           1.059 0.050 21.204  0.000    0.963    1.156
#> 7         Y ~1                   -0.013 0.026 -0.495  0.621   -0.063    0.038
#> 8         M ~1                   -0.022 0.030 -0.753  0.452   -0.081    0.035
#> 9         X ~1                    0.002 0.034  0.073  0.941   -0.065    0.068
#> 10 indirect :=      a*b indirect  0.246 0.021 11.930  0.000    0.206    0.288
#> 11   direct :=       cp   direct  0.234 0.030  7.881  0.000    0.177    0.292
#> 12    total := cp+(a*b)    total  0.479 0.029 16.505  0.000    0.423    0.537
```
