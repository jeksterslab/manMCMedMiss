...
#> cp        0.2335 0.0289 5000  0.1344  0.1603  0.1783 0.2906 0.3065 0.3295
#> b         0.5112 0.0294 5000  0.4102  0.4340  0.4544 0.5680 0.5871 0.6087
#> a         0.4809 0.0287 5000  0.3880  0.4116  0.4263 0.5382 0.5595 0.5789
#> Y~~Y      0.5542 0.0267 5000  0.4683  0.4854  0.5017 0.6054 0.6230 0.6419
#> M~~M      0.7564 0.0360 5000  0.6344  0.6635  0.6873 0.8267 0.8492 0.8709
#> X~~X      1.0591 0.0495 5000  0.9036  0.9403  0.9649 1.1597 1.1893 1.2200
#> Y~1      -0.0127 0.0252 5000 -0.0886 -0.0771 -0.0625 0.0362 0.0524 0.0675
#> M~1      -0.0223 0.0293 5000 -0.1197 -0.0991 -0.0789 0.0355 0.0514 0.0705
#> X~1       0.0025 0.0339 5000 -0.1036 -0.0841 -0.0623 0.0682 0.0881 0.1070
#> indirect  0.2458 0.0202 5000  0.1861  0.1959  0.2083 0.2876 0.2989 0.3145
#> direct    0.2335 0.0289 5000  0.1344  0.1603  0.1783 0.2906 0.3065 0.3295
#> total     0.4794 0.0280 5000  0.3895  0.4115  0.4246 0.5354 0.5503 0.5716
```
...
#> 1         Y  ~        X       cp  0.234 0.030  7.668  0.000    0.172    0.294
#> 2         Y  ~        M        b  0.511 0.031 16.683  0.000    0.452    0.573
#> 3         M  ~        X        a  0.481 0.029 16.636  0.000    0.424    0.536
#> 4         Y ~~        Y           0.554 0.028 20.034  0.000    0.499    0.608
#> 5         M ~~        M           0.756 0.037 20.491  0.000    0.684    0.830
#> 6         X ~~        X           1.059 0.051 20.604  0.000    0.958    1.162
#> 7         Y ~1                   -0.013 0.025 -0.500  0.617   -0.063    0.038
#> 8         M ~1                   -0.022 0.029 -0.770  0.442   -0.081    0.034
#> 9         X ~1                    0.002 0.033  0.075  0.940   -0.063    0.068
#> 10 indirect :=      a*b indirect  0.246 0.020 12.063  0.000    0.207    0.287
#> 11   direct :=       cp   direct  0.234 0.030  7.668  0.000    0.172    0.294
#> 12    total := cp+(a*b)    total  0.479 0.029 16.297  0.000    0.421    0.537
```
