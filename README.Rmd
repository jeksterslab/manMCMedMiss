...
**Monte Carlo Confidence Intervals for the Indirect Effect with Missing Data** containing scripts used in the simulation study and other supplementary materials.
