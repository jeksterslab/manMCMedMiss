...
FitModelML <- function(data,
  ...
  vcovs <- .SymofVech(
    c(
      vcovs[1, 1], vcovs[1, 2], vcovs[1, 4], vcovs[2, 2], vcovs[3, 1], vcovs[4, 1], vcovs[5, 2], vcovs[6, 4], vcovs[8, 2], # nolint: line_length_linter.
      vcovs[1, 3], vcovs[1, 5], vcovs[2, 3], vcovs[3, 2], vcovs[4, 2], vcovs[5, 3], vcovs[6, 5], vcovs[8, 3], # nolint: line_length_linter.
      vcovs[2, 1], vcovs[2, 4], vcovs[3, 3], vcovs[4, 3], vcovs[5, 4], vcovs[7, 1], vcovs[8, 4], # nolint: line_length_linter.
      vcovs[2, 5], vcovs[3, 4], vcovs[4, 4], vcovs[5, 5], vcovs[7, 2], vcovs[8, 5], # nolint: line_length_linter.
